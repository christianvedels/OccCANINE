# German occupational census
# Created:    2024-06-18
# Auhtors:    Christian Vedel [christian-vs@sam.sdu.dk],
#
# Purpose:    Clean HISCO codes for German occupational census 1884
#
...
# ==== Read data ====
data0 = read_dta("Data/Raw_data/2404_New_data/German_table/German_table.dta")

# ==== Cleaning data0 ====
data0 = data0 %>% 
  select(occupation, HISCO) %>% 
  mutate(Year = 1884) %>% 
  mutate(Type = "Descriptions") %>% 
  filter(HISCO != "")
...
# ==== Save ====
save(data1, file = "Data/Tmp_data/German_occupational_census.Rdata")
