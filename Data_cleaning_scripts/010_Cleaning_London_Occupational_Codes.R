# Cleaning LOC (London Occupational Codes)
# Created:    2023-11-06
# Auhtors:    Christian Vedel [christian-vs@sam.sdu.dk],
#
# Purpose:    This script cleans Swedish data from London Occupational Codes
#
...
# ==== Read data ====
data0 = read_delim("Data/Raw_data/London Occupational Codes/lndn1866_01.csv")
...
# ==== Save ====
save(data1, file = "Data/Tmp_data/Clean_LOC_EN.Rdata")
