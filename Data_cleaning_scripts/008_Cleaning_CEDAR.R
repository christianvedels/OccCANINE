...
#
# Purpose:    This script cleans Swedish data from CEDAR
#
...
# ==== Read data ====
data0 = read_delim("Data/Raw_data/SWEDISH_CEDAR/SWEDISH_CEDAR HISCO.txt", locale = locale(encoding = "ISO-8859-1"))
...
# ==== Save ====
save(data1, file = "Data/Tmp_data/Clean_CEDAR_SE.Rdata")
