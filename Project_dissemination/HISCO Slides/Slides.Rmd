...
- .red123[Today:] New and old results
...
.footnote[
.small123[
*Based on 100k million test observations*
]
]
...
.panel[
  .panel-name[Version 0.2 - 'flat']
```{r echo=FALSE, message=FALSE, warning=FALSE, out.height="450px", out.width="675px"}
knitr::include_graphics("Figures/Performance_by_lang_flat.png")
```
].panel[
  .panel-name[Version 0.2 - 'greedy']
```{r echo=FALSE, message=FALSE, warning=FALSE, out.height="450px", out.width="675px"}
...
- Extensions possble
- Seperate paper: Will be presented in WEHC in Lund and IC2S2 in Norrköping this summer
...
- Testing 'finetunability' to OCC1950, OCCICEM, PST, ISCO68 
- Two user end options: *'fast'* or *'good'*
]
