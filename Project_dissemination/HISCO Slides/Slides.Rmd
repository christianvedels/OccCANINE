...
- ML/NLP crowd: A new application + small novel loss function
...
.red[
~10k HISCO codes in minutes
~1 million HISCO codes in a few hours  
...
- We generate adverse examples: Change strings until the model marginally fails *+ gibberish + translated strings*
...
- 30 days of training
- Batch size: 512
- 15.8 million training observations (occupations with HISCO codes)
...
---
# Out of distribution (manually validated)
...
---
# More OOD testing (already labelled data)
...
$\rightarrow$ *Open source - we're still developing.*
...
.pull-left[
- We use Adam optimizer (adaptive momentum optimizer)
- Two loss functions:
