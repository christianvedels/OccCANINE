...
### Ongoing work
- Replacing the brains by a transformer model (XML-RoBERTA)
...
.pull-left[
### XML-RoBERTa
- Pretrained multilingual model trained on 100 different languages 
- Inherently understands different languages 
- Trained on 2.5TB of internet text 
...
### Fine tuning
- Add classification layer on top of existing architecture
- Modify some strings with language token:
  + "UNK" + "He is a farmer"
  + "EN" + "He is a farmer" 
- Fine tune the model 
]
